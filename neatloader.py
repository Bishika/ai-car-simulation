...
class neatloader:
    ...
    def train(
        ...
        self.control_results.append(
            [self.Game.population.generation + 1, self.Game.best_time / 1000]
        )
        self.control_generations = self.Game.population.generation + 1
...
if __name__ == "__main__":
    ...
    def average_eval(results_set):
        ...
        for m in results_set:
            ...
            for g, l in m:
                gens += g
                lap_time += l
            averages_by_map.append([gens / len(m), lap_time / len(m)])
    ...
    # loader.train_control(20, True)
    # loader.train_control(20, True)
    # loader.train_control(20, True, True)
1
# loader.average_control(loader.control_results)


# loader.save_genomes()


# Game.replay_genome(Game.load_genome('neat-checkpoint-map-5-best_genome'))
# control_results_set.append(control_results)
...
#     for x in range(1, 10):
#         train_control(20, True)
#         #Restore to control so the network doesn't retrain each map
#         # Game.population = Game.cur_checkpoint.restore_checkpoint(Game.cur_checkpoint.filename_prefix + str(control_generations))
#         # Game.population = Game.cur_checkpoint.restore_checkpoint('neat-checkpoint-map-100')
#         # print('Loaded ' + Game.cur_checkpoint.filename_prefix + str(control_generations))

#         # Run until solution found
#         Game.population.run(Game.run_simulation)
#         gens_for_lap += (Game.population.generation - control_generations)
#         lap_time += Game.best_time / 1000

#     control_results_set.append([gens_for_lap / 10, lap_time / 10]) #Average Scores for each map
...
# for m in maps:
#     Game = NeatGame.NeatGame(10, m)

# final_control_res = []
# for gen, time in control_results_set:
# final_control_res[:] = [sum(x) for x in control_results_set]
# control_results_set = [[[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]], [[15, 9.869], [0, 8.025], [0, 7.688], [1, 9.042], [0, 5.181], [0, 7.958], [1, 9.533], [0, 7.43], [0, 7.231], [0, 8.271], [0, 7.462], [0, 7.847], [1, 9.123], [1, 6.893], [0, 6.857], [1, 6.315], [0, 7.64], [2, 7.464], [3, 6.188], [1, 7.906], [0, 4.713], [3, 9.089], [3, 8.202], [5, 8.293], [4, 6.219], [0, 6.946], [0, 4.766], [0, 8.693], [0, 5.049], [1, 7.827], [3, 6.16], [1, 6.189], [0, 4.625], [0, 5.469], [0, 5.099], [4, 7.891], [3, 6.093], [1, 7.627], [0, 4.718], [3, 8.333], [0, 5.126], [1, 7.189], [2, 6.215], [1, 6.833], [0, 4.799], [4, 5.438], [0, 5.198], [1, 7.417], [2, 6.103], [0, 7.985], [0, 4.64], [0, 5.443], [0, 5.029], [3, 8.051]]]

# print('Training Generations required - Lap Time')
# for res in loader.control_results_set:
#     print(res)
